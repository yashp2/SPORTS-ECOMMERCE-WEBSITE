...
import product from './TennisData.json';
...
function Tennis() {
  ...
  return (
    <>
    <MainMenu />
     <div className="w-full h-auto bg-[#8543c4]">
     <div className="Tennis-bg w-10/12 mx-auto md:h-[20vh] h-[50vh]"></div>
